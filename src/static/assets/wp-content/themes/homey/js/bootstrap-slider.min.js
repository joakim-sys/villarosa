    ...
    (function (a) {
      function e(b, c) {
        ...
        if (this.sliderElem) p = !0;
          ...
          if (Array.isArray(s) && s.length > 0)
            for (var t = 0; t < s.length; t++) {
              var u = document.createElement("div"),
                v = s[t]["class"] || "";
              (u.className = "slider-rangeHighlight slider-selection " + v),
                this.rangeHighlightElements.push(u),
                r.appendChild(u);
            }
          ...
          (F.className = "tooltip tooltip-main"),
            F.setAttribute("role", "presentation"),
            E(F);
          var G = document.createElement("div");
          (G.className = "tooltip tooltip-min"),
            G.setAttribute("role", "presentation"),
            E(G);
          var H = document.createElement("div");
          (H.className = "tooltip tooltip-max"),
        ...
        if (
          ...
          var N = K ? { passive: !0 } : !1;
          this.sliderElem.addEventListener("touchstart", this.touchstart, N),
            this.sliderElem.addEventListener("touchmove", this.touchmove, N);
        }
        if (
          ...
          if (
            ...
            (this.handleCallbackMap.handle1 = { mouseEnter: P, mouseLeave: Q }),
              (P = O.addMouseEnter(this, this.handle2)),
              (Q = O.addMouseLeave(this, this.handle2)),
        ...
        g = {
          ...
          logarithmic: {
            toValue: function (a) {
              ...
              return Math.round(d) === this.options.max
                ? this.options.max
                : ((d =
                    this.options.min +
