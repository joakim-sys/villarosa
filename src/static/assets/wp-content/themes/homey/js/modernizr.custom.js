 ...
 * http://modernizr.com/download/?-animation-cssanimations-cssmask-csspseudoanimations-cssresize-csstransforms3d-csstransitions-cssvalid-cssvmaxunit-cssvwunit-ellipsis-multiplebgs-overflowscrolling-requestanimationframe-subpixelfont-target-textshadow-webpanimation-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-printshiv-setclasses-testallprops-testprop-teststyles !*/ !(function (
  ...
  function a(e, t) {
    if ("object" == typeof e) for (var n in e) z(e, n) && a(n, e[n]);
    else {
      e = e.toLowerCase();
      var r = e.split("."),
        i = Modernizr[r[0]];
  ...
  function c(e, n, r, i) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (l = s("div")), (l.id = i ? i[r] : d + (r + 1)), c.appendChild(l);
    return (
      (o = s("style")),
      (o.type = "text/css"),
      (o.id = "s" + d),
  ...
  function v(e, t, n) {
    ...
    for (var o in e)
      if (e[o] in t)
        return n === !1
          ? e[o]
          : ((i = t[e[o]]), r(i, "function") ? h(i, n || t) : i);
    return !1;
  }
  function g(e, t, i, o) {
    function a() {
    ...
    for (var d, f, c, h, v, g = ["modernizr", "tspan"]; !D.style; )
      (d = !0), (D.modElem = s(g.shift())), (D.style = D.modElem.style);
      ...
      function a(e, n, r) {
        ...
        return (
          (i = r.cache[e]
            ...
            : r.createElem(e)),
          !i.canHaveChildren || A.test(e) || i.tagUrn
            ? i
  ...
  !(function () {
    ...
    Modernizr.addAsyncTest(function () {
      var e = new Image();
      (e.onerror = function () {
        a("webpanimation", !1, { aliases: ["webp-animation"] });
      }),
        (e.onload = function () {
          a("webpanimation", 1 == e.width, { aliases: ["webp-animation"] });
        }),
        (e.src =
  ...
  (b.prefixedCSSValue = P),
    Modernizr.addTest("webanimations", "animate" in s("div")),
    ...
    function (t) {
      ...
      (n.innerHTML = "This is a text written in Arial"),
        Modernizr.addTest(
          "subpixelfont",
          e.getComputedStyle
            ? "44px" !== e.getComputedStyle(n, null).getPropertyValue("width")
            : !1
        );
    },
    1,
  ...
  Modernizr.addTest("requestanimationframe", !!U("requestAnimationFrame", e), {
    ...
    (b.testAllProps = A),
    Modernizr.addTest("cssanimations", A("animationName", "a", !0)),
    Modernizr.addTest("csspseudoanimations", function () {
      ...
      return (
        Modernizr.testStyles(n, function (n) {
          t =
            "10px" ===
    ...
    Modernizr.addTest("ellipsis", A("textOverflow", "ellipsis")),
    Modernizr.addTest("cssmask", A("maskRepeat", "repeat-x", !0)),
    Modernizr.addTest("overflowscrolling", A("overflowScrolling", "touch", !0)),
    Modernizr.addTest("cssresize", A("resize", "both", !0)),
    ...
    Modernizr.addTest("csstransitions", A("transition", "all", !0)),
    i(),
    o(x),
    delete b.addTest,
